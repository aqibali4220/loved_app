  ...
  Future<bool> getFromGallery(BuildContext context) async {
    ...
    if (await platform.status.isDenied) {
      if (Platform.isIOS) {
        ...
        showDeleteDialog(context,"Loved Ones app requires access to the gallery to upload pictures");
  ...
  Future<bool> getFromCamera(BuildContext context) async {
    ...
    if (await Permission.camera.status.isDenied) {
      if (Platform.isIOS) {
        ...
        showDeleteDialog(context,"Loved Ones app requires access to the camera to upload pictures");
    ...
    if (await Permission.camera.status.isPermanentlyDenied) {
      if (Platform.isIOS) {
        ...
        showDeleteDialog(context,"Loved Ones app requires access to the camera to capture pictures");
      }
